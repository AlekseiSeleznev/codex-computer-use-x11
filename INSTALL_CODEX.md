# Install codex-computer-use-x11 v0.1.0
...
`v0.1.0` supports the documented Linux Mint Cinnamon on X11 baseline with backend id `x11-ewmh`.

Out of scope for this release:

- Cinnamon Wayland;
- mandatory portal-based runtime paths;
