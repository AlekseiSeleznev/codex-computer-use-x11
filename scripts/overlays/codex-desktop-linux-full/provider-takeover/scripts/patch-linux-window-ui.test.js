...
test("default core patch descriptors are grouped and unique", () => {
  ...
  const expectedIds = [
    ...
    "linux-x11-computer-use-provider-takeover",
...
function computerUseSettingsRowsBundleFixture() {
  return [
    "var we=`computer-use`,Te=`chrome`;",
    "function je(e){let t=(0,Z.c)(58),{computerUseAvailability:r}=e,{selectedHostId:a}=ce(),u=[];let d=k(a,u),f=pe(a),p;",
    "t[4]!==f||t[5]!==d.availablePlugins?(p=X(d.availablePlugins,we,f),t[4]=f,t[5]=d.availablePlugins,t[6]=p):p=t[6];let m=p,h;",
    "t[7]!==f||t[8]!==d.availablePlugins?(h=Ge(d.availablePlugins,f),t[7]=f,t[8]=d.availablePlugins,t[9]=h):h=t[9];let g=h,w=[];",
    "if(r.available&&m!=null){let e,n;t[34]===Symbol.for(`react.memo_cache_sentinel`)?(e=(0,Q.jsx)(s,{id:`settings.computerUse.anyApp.title`,defaultMessage:`Any App`}),n=(0,Q.jsx)(s,{id:`settings.computerUse.anyApp.description`,defaultMessage:`Let Codex control apps on your computer`}),t[34]=e,t[35]=n):(e=t[34],n=t[35]);let r;t[36]===m?r=t[37]:(r={plugin:m,title:e,description:n},t[36]=m,t[37]=r),w.push(r)}",
    "if(g!=null){let e=(0,Q.jsx)(s,{id:`settings.computerUse.chrome.pluginTitle`,defaultMessage:`Google Chrome`});let a={plugin:g,title:e};w.push(a)}",
    "return he({items:w,pluginsQuery:d,selectedHostId:a})}",
  ].join("");
}

function currentMemoizedComputerUseSettingsRowsBundleFixture() {
  return [
    "var we=`computer-use`,Te=`chrome`;",
    "function je(e){let t=(0,Z.c)(48),{computerUseAvailability:r}=e,i=b(),{selectedHostId:a}=ce(),o=n(a).kind===`local`,s;t[0]===a?s=t[1]:(s={hostId:a},t[0]=a,t[1]=s);let c=O(s),u;t[2]===Symbol.for(`react.memo_cache_sentinel`)?(u=[],t[2]=u):u=t[2];let d=k(a,u),f=pe(a),p;",
    "t[3]!==f||t[4]!==d.availablePlugins?(p=X(d.availablePlugins,we,f),t[3]=f,t[4]=d.availablePlugins,t[5]=p):p=t[5];let m=p,h;",
    "t[6]!==f||t[7]!==d.availablePlugins?(h=Ge(d.availablePlugins,f),t[6]=f,t[7]=d.availablePlugins,t[8]=h):h=t[8];let g=h,x={},S,T;",
    "if(t[13]!==g||t[14]!==x||t[15]!==r.available||t[16]!==m||t[17]!==c||t[18]!==false||t[19]!==o||t[20]!==i){S=[];let e;if(t[23]!==g||t[24]!==c||t[25]!==o?(e=g==null&&o&&!c.isLoading&&!c.allowed?[{id:`chrome-unavailable`,title:(0,Q.jsx)(l,{id:`settings.computerUse.chrome.pluginTitle`,defaultMessage:`Google Chrome`})}]:[],t[23]=g,t[24]=c,t[25]=o,t[26]=e):e=t[26],T=e,r.available&&m!=null){let e,n;t[27]===Symbol.for(`react.memo_cache_sentinel`)?(e=(0,Q.jsx)(l,{id:`settings.computerUse.anyApp.title`,defaultMessage:`Any App`}),n=(0,Q.jsx)(l,{id:`settings.computerUse.anyApp.description`,defaultMessage:`Let Codex control apps on your computer`}),t[27]=e,t[28]=n):(e=t[27],n=t[28]);let r;t[29]===m?r=t[30]:(r={plugin:m,title:e,description:n},t[29]=m,t[30]=r),S.push(r)}if(g!=null){let e;t[31]===Symbol.for(`react.memo_cache_sentinel`)?(e=(0,Q.jsx)(l,{id:`settings.computerUse.chrome.pluginTitle`,defaultMessage:`Google Chrome`}),t[31]=e):e=t[31];let a={plugin:g,title:e};S.push(a)}t[13]=g,t[14]=x,t[15]=r.available,t[16]=m,t[17]=c,t[18]=false,t[19]=o,t[20]=i,t[21]=S,t[22]=T}else S=t[21],T=t[22];let E,D;",
    "return (0,Q.jsx)(he,{items:S,pluginsQuery:d,selectedHostId:a,unavailableItems:T})}",
  ].join("");
}
...
test("Computer Use provider baseline diagnostics explain bundled row decisions", () => {
  const shown = resolveComputerUseProviderRows({
    availablePlugins: [
      { id: "computer-use", marketplaceName: "openai-bundled" },
      { id: "chrome", marketplaceName: "openai-bundled" },
    ],
    installedPlugins: [],
    computerUseAvailability: { available: true, isFetching: false, isLoading: false },
  });

  assert.deepEqual(shown.rowDecisions.find((row) => row.provider === "bundled"), {
    provider: "bundled",
  ...
  const gated = resolveComputerUseProviderRows({
    availablePlugins: [{ id: "computer-use", marketplaceName: "openai-bundled" }],
    installedPlugins: [],
    computerUseAvailability: { available: false, isFetching: false, isLoading: false },
  });

  assert.deepEqual(gated.rowDecisions.find((row) => row.provider === "bundled"), {
    provider: "bundled",
    pluginId: "computer-use",
    lookupSource: "availablePlugins",
    state: "hidden",
  ...
  const missing = resolveComputerUseProviderRows({
    availablePlugins: [],
    installedPlugins: [],
    computerUseAvailability: { available: true, isFetching: false, isLoading: false },
  });

  assert.deepEqual(missing.rowDecisions.find((row) => row.provider === "bundled"), {
    provider: "bundled",
    pluginId: "computer-use",
    lookupSource: "none",
    state: "absent",
    reason: "bundled-plugin-missing",
  });
});

test("Computer Use provider diagnostics serialize sanitized runtime payload", () => {
  const report = buildComputerUseProviderDiagnostics({
    markerVersion: "codex-computer-use-x11-provider-takeover:v1",
    asset: "computer-use-settings-test.js",
    availablePlugins: [
      {
        id: "computer-use",
      ...
      { id: "codex-computer-use-x11", marketplaceName: "codex-computer-use-x11" },
    ],
    installedPlugins: [
      { id: "codex-computer-use-x11", marketplaceName: "codex-computer-use-x11", enabled: true },
    ],
    computerUseAvailability: { available: false, isFetching: false, isLoading: false },
    gateFacts: { hostPlatform: "linux", selectedHostId: "local" },
    mode: "takeover",
    provider: "x11",
  });

  assert.equal(report.markerVersion, "codex-computer-use-x11-provider-takeover:v1");
  assert.equal(report.asset, "computer-use-settings-test.js");
  assert.deepEqual(report.availablePlugins, [
    { id: "computer-use", marketplaceName: "openai-bundled", displayName: "Computer Use" },
    { id: "codex-computer-use-x11", marketplaceName: "codex-computer-use-x11", displayName: null },
  ]);
  assert.deepEqual(report.installedPlugins, [
    { id: "codex-computer-use-x11", marketplaceName: "codex-computer-use-x11", displayName: null },
  ]);
  assert.equal(report.computerUseAvailability.available, false);
  assert.deepEqual(report.gateFacts, { hostPlatform: "linux", selectedHostId: "local" });
  assert.ok(report.rowDecisions.some((row) => row.provider === "x11" && row.state === "shown"));
  assert.doesNotMatch(JSON.stringify(report), /must-not-leak|privateUrl|secret/);
});

test("X11 provider takeover hides bundled Computer Use row while preserving Chrome", () => {
  ...
  assert.deepEqual(resolved.rowDecisions.find((row) => row.provider === "bundled"), {
    provider: "bundled",
    pluginId: "computer-use",
    lookupSource: "availablePlugins",
    state: "hidden",
  ...
  assert.deepEqual(resolved.rowDecisions.find((row) => row.provider === "x11"), {
    provider: "x11",
    pluginId: "codex-computer-use-x11",
    lookupSource: "installedPlugins",
    state: "shown",
    reason: "x11-takeover-selected",
  });

  const patched = applyPatchTwice(applyX11ComputerUseSettingsRowPatch, currentMemoizedComputerUseSettingsRowsBundleFixture());

  assert.match(patched, new RegExp(COMPUTER_USE_PROVIDER_TAKEOVER_MARKER));
  assert.match(patched, /codexLinuxComputerUseTakeoverProvider!=null/);
  assert.match(patched, /false&&r\.available&&m!=null/);
  assert.match(patched, /settings\.computerUse\.chrome\.pluginTitle/);
});

test("X11 provider takeover row is installed-first and reports unavailable when missing", () => {
  const installed = resolveComputerUseProviderRows({
    mode: "takeover",
    provider: "x11",
    availablePlugins: [{ id: "codex-computer-use-x11", marketplaceName: "codex-computer-use-x11" }],
    installedPlugins: [{ id: "codex-computer-use-x11", marketplaceName: "codex-computer-use-x11" }],
    computerUseAvailability: { available: false, isFetching: false, isLoading: false },
  });
  assert.equal(installed.rowDecisions.find((row) => row.provider === "x11").lookupSource, "installedPlugins");

  const available = resolveComputerUseProviderRows({
    mode: "takeover",
    provider: "x11",
    availablePlugins: [{ id: "codex-computer-use-x11", marketplaceName: "codex-computer-use-x11" }],
    installedPlugins: [],
  ...
  assert.equal(available.rowDecisions.find((row) => row.provider === "x11").lookupSource, "availablePlugins");
  ...
  assert.deepEqual(missing.rowDecisions.find((row) => row.provider === "x11"), {
    provider: "x11",
    pluginId: "codex-computer-use-x11",
    lookupSource: "none",
    state: "unavailable",
    reason: "x11-provider-missing",
  });

  const patched = applyPatchTwice(applyX11ComputerUseSettingsRowPatch, currentMemoizedComputerUseSettingsRowsBundleFixture());

  assert.match(patched, /codexLinuxComputerUseTakeoverProvider=\(\(d\.installedPlugins\?\?\[\]\)\.find\(e=>/);
  assert.match(patched, /e\.marketplaceName===`codex-computer-use-x11`/);
  assert.doesNotMatch(patched, /codexLinuxComputerUseTakeoverProvider=X\(d\.installedPlugins/);
  assert.match(patched, /codexLinuxComputerUseProviderShim:!0/);
  assert.doesNotMatch(patched, /push\(\{id:`codex-computer-use-x11-unavailable`/);
});

test("adds X11 Computer Use takeover row to current Computer Use settings bundle", () => {
  const source = computerUseSettingsRowsBundleFixture();

  const patched = applyPatchTwice(applyX11ComputerUseSettingsRowPatch, source);

  assert.match(patched, new RegExp(COMPUTER_USE_PROVIDER_TAKEOVER_MARKER));
  assert.match(patched, /codexLinuxComputerUseTakeoverProvider=\(\(d\.installedPlugins\?\?\[\]\)\.find\(e=>/);
  assert.match(patched, /e\.marketplaceName===`codex-computer-use-x11`/);
  assert.doesNotMatch(patched, /codexLinuxComputerUseTakeoverProvider=X\(d\.installedPlugins/);
  assert.match(patched, /title:`X11 Computer Use`/);
  assert.match(patched, /description:`Standalone X11\/EWMH desktop control tools`/);
  assert.match(patched, /codexLinuxComputerUseProviderShim:!0/);
  assert.doesNotMatch(patched, /push\(\{id:`codex-computer-use-x11-unavailable`/);
  assert.match(patched, /settings\.computerUse\.anyApp\.title/);
  assert.match(patched, /settings\.computerUse\.chrome\.pluginTitle/);
  assert.match(patched, /if\(false&&r\.available&&m!=null\)/);
  assert.doesNotMatch(patched, /codexLinuxX11Plugin/);
  assert.equal(applyX11ComputerUseSettingsRowPatch(patched), patched);
});



test("upgrades marketplace-filtered X11 provider lookup", () => {
  const safe = applyPatchTwice(applyX11ComputerUseSettingsRowPatch, currentMemoizedComputerUseSettingsRowsBundleFixture());
  const unsafe = safe.replace(
    /let m=p,codexLinuxComputerUseTakeoverProvider=\(\(d\.installedPlugins\?\?\[\]\)\.find\(e=>\(e\.plugin\?\.name\?\?e\.name\)===`codex-computer-use-x11`\|\|\(e\.plugin\?\.id\?\?e\.id\?\?``\)\.split\(`@`\)\[0\]===`codex-computer-use-x11`\|\|e\.marketplaceName===`codex-computer-use-x11`\)\?\?d\.availablePlugins\.find\(e=>\(e\.plugin\?\.name\?\?e\.name\)===`codex-computer-use-x11`\|\|\(e\.plugin\?\.id\?\?e\.id\?\?``\)\.split\(`@`\)\[0\]===`codex-computer-use-x11`\|\|e\.marketplaceName===`codex-computer-use-x11`\)\),h;\/\*codex-computer-use-x11-provider-takeover:v1\*\//,
    "let m=p,codexLinuxComputerUseTakeoverProvider=X(d.installedPlugins??[],`codex-computer-use-x11`,f)??X(d.availablePlugins,`codex-computer-use-x11`,f),h;/*codex-computer-use-x11-provider-takeover:v1*/",
  );

  const upgraded = applyX11ComputerUseSettingsRowPatch(unsafe);

  assert.match(upgraded, /codexLinuxComputerUseTakeoverProvider=\(\(d\.installedPlugins\?\?\[\]\)\.find\(e=>/);
  assert.match(upgraded, /e\.marketplaceName===`codex-computer-use-x11`/);
  assert.doesNotMatch(upgraded, /codexLinuxComputerUseTakeoverProvider=X\(d\.installedPlugins/);
});

test("upgrades unsafe X11 takeover unavailable row out of plugin items", () => {
  const unsafe = applyPatchTwice(applyX11ComputerUseSettingsRowPatch, currentMemoizedComputerUseSettingsRowsBundleFixture())
    .replace(
      /}else S=t\[21\],T=t\[22\];S=S\?\?\[\];T=T\?\?\[\];codexLinuxComputerUseTakeoverProvider!=null&&!S\.some\(e=>e\.plugin===codexLinuxComputerUseTakeoverProvider\)&&\(S=\[\.\.\.S,\{plugin:codexLinuxComputerUseTakeoverProvider,title:`X11 Computer Use`,description:`Standalone X11\/EWMH desktop control tools`,codexLinuxComputerUseProviderShim:!0\}\]\);codexLinuxComputerUseTakeoverProvider==null&&!T\.some\(e=>e\.id===`codex-computer-use-x11-unavailable`\)&&\(T=\[\.\.\.T,\{id:`codex-computer-use-x11-unavailable`,title:`X11 Computer Use`,description:`X11 provider takeover is enabled but codex-computer-use-x11 is not installed or available`,codexLinuxComputerUseProviderUnavailable:!0\}\]\);let E,D;/,
      "}else S=t[21],T=t[22];codexLinuxComputerUseTakeoverProvider!=null&&!S.some(e=>e.plugin===codexLinuxComputerUseTakeoverProvider)&&S.push({plugin:codexLinuxComputerUseTakeoverProvider,title:`X11 Computer Use`,description:`Standalone X11/EWMH desktop control tools`,codexLinuxComputerUseProviderShim:!0});codexLinuxComputerUseTakeoverProvider==null&&!S.some(e=>e.id===`codex-computer-use-x11-unavailable`)&&S.push({id:`codex-computer-use-x11-unavailable`,title:`X11 Computer Use`,description:`X11 provider takeover is enabled but codex-computer-use-x11 is not installed or available`,codexLinuxComputerUseProviderUnavailable:!0});let E,D;",
    );

  const upgraded = applyX11ComputerUseSettingsRowPatch(unsafe);

  assert.match(upgraded, /codexLinuxComputerUseTakeoverProvider==null&&!T\.some\(e=>e\.id===`codex-computer-use-x11-unavailable`\)&&\(T=\[\.\.\.T,/);
  assert.doesNotMatch(upgraded, /S\.push\(\{id:`codex-computer-use-x11-unavailable`/);
});

test("adds X11 Computer Use takeover row for current memoized settings bundle", () => {
  const source = currentMemoizedComputerUseSettingsRowsBundleFixture();
  ...
  assert.match(patched, /settings\.computerUse\.chrome\.pluginTitle/);
  assert.match(patched, /false&&r\.available&&m!=null/);
  assert.match(patched, /codexLinuxComputerUseTakeoverProvider!=null&&!S\.some\(e=>e\.plugin===codexLinuxComputerUseTakeoverProvider\)&&\(S=\[\.\.\.S,/);
  assert.match(patched, /codexLinuxComputerUseTakeoverProvider==null&&!T\.some\(e=>e\.id===`codex-computer-use-x11-unavailable`\)&&\(T=\[\.\.\.T,/);
  assert.doesNotMatch(patched, /S\.push\(\{id:`codex-computer-use-x11-unavailable`/);
  assert.doesNotMatch(patched, /codexLinuxX11Plugin/);
  assert.equal(applyX11ComputerUseSettingsRowPatch(patched), patched);
});

test("migrates older X11 Computer Use side-by-side row patch to takeover lookup", () => {
  const stale = currentMemoizedComputerUseSettingsRowsBundleFixture()
    .replace(
      "let m=p,h;",
      "let m=p,codexLinuxX11Plugin=X(d.availablePlugins,`codex-computer-use-x11`,f),h;",
    )
    .replace(
      "}else S=t[21],T=t[22];let E,D;",
      "}else S=t[21],T=t[22];codexLinuxX11Plugin!=null&&!S.some(e=>e.plugin===codexLinuxX11Plugin)&&S.push({plugin:codexLinuxX11Plugin,title:`X11 Computer Use`,description:`Standalone X11/EWMH desktop control tools`});let E,D;",
    );

  const migrated = applyX11ComputerUseSettingsRowPatch(stale);

  assert.match(migrated, /codexLinuxComputerUseTakeoverProvider=\(\(d\.installedPlugins\?\?\[\]\)\.find\(e=>/);
  assert.doesNotMatch(migrated, /codexLinuxComputerUseTakeoverProvider=X\(d\.installedPlugins/);
  assert.match(migrated, new RegExp(COMPUTER_USE_PROVIDER_TAKEOVER_MARKER));
  assert.match(migrated, /false&&r\.available&&m!=null/);
  assert.doesNotMatch(migrated, /codexLinuxX11Plugin/);
  assert.equal(applyX11ComputerUseSettingsRowPatch(migrated), migrated);
});

test("warns and skips X11 Computer Use settings row patch when row shape drifts", () => {
  const source = "function je(){return `settings.computerUse.anyApp.title` + `computer-use`}";

  const { value: patched, warnings } = captureWarns(() =>
    applyX11ComputerUseSettingsRowPatch(source),
  );
