...
if [ -n "${CODEX_X11_COMPUTER_USE_RELEASE_TARBALL:-}" ]; then
    ...
    echo "No codex-computer-use-x11 staging source configured. Set CODEX_X11_COMPUTER_USE_RELEASE_TARBALL, CODEX_X11_COMPUTER_USE_BINARY, CODEX_X11_COMPUTER_USE_SOURCE, or CODEX_X11_COMPUTER_USE_DOWNLOAD_URL." >&2
    exit 1
fi
