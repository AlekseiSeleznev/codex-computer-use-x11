...
![Version](https://img.shields.io/badge/version-v0.1.1-84cc16) ![License](https://img.shields.io/badge/license-MIT-blue) ![Rust](https://img.shields.io/badge/Rust-2021-f97316) ![Linux](https://img.shields.io/badge/Linux%20Mint-Cinnamon%2FX11-87cf3e)
...
**Release:** `v0.1.1` is the current fresh public baseline: it keeps the standalone plugin, safe installer/uninstaller, source-overlay staging, production-readiness evidence, current OpenSpec specs, rollback-first documentation, a live-verified AT-SPI doctor fix, and X11-only doctor readiness with RemoteDesktop/Wayland facts kept debug-only.
