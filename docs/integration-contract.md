...
arbitrary app/window subtree selection. Diagnostics should keep screenshot
provider readiness separate from RemoteDesktop input readiness and should treat
empty RemoteDesktop introspection as unavailable.
