...
`test-plan.md` is the mandatory Matt TDD planning gate. `apply`, `verify`,
and `archive` are lifecycle phases that must consume committed/validated
artifacts and keep `openspec/specs/` synchronized after archive. These are OpenSpec
