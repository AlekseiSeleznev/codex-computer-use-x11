# x11-target-window-groups-overlays Specification

## Purpose
This specification defines the standalone X11 target-window group and overlay
boundary contract for `codex-computer-use-x11`, including CLI target state,
group/active-window tracking, stale target validation, and non-blocking overlay
diagnostics.
## Requirements
