# x11-active-window-focus Specification

## Purpose
This specification defines the standalone X11/EWMH active-window and focus-verification command surface for `codex-computer-use-x11`, including read-only focused-window reporting and safe activation results that only succeed after fresh active-window identity verification.
## Requirements
