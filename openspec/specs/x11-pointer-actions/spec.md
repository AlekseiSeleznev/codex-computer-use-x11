# x11-pointer-actions Specification

## Purpose
Defines the standalone X11/EWMH pointer action contract for verified click, scroll, and drag routing in root/global coordinates, including explicit global mode and MCP wrappers.
